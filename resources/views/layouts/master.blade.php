          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item ">
              <a href="add-leads.html" class="menu-link">
                ...
                <div data-i18n="Add Leads">Setup</div>
            ...
            <li class="menu-item">
              <a href="tables-basic.html" class="menu-link">
                ...
                <div data-i18n="TAll Leads">Managements</div>
              </a>
            </li>
            <ul>
                <li>
            ...
            <li class="menu-item ">
                <a href="add-leads.html" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-plus"></i>
                  <div data-i18n="Add Leads">Reports</div>
